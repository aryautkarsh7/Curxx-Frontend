...
export default function PartnerSections({ sections, eyebrow = 'For Providers', title = 'Built for Doctors, Hospitals and Employers', sectionHeadings = false }: { sections: PartnerSection[]; eyebrow?: string; title?: string; sectionHeadings?: boolean }) {
