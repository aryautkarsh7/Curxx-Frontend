...
export default function DoctorsNoresultsPagePage({ plural }: { plural: string }) {
  const { onFilterChange, setAvailability, clearFilters } = useListingControls();
  return (
    <>
...
<p className="font-caption text-caption text-[#78716C]">0 verified dermatologists found · Try adjusting your filters</p>
</div>
</div>
{/* Sort Control */}
...
{/* Applied Chips */}
<div className="flex flex-wrap gap-1.5 pb-3 border-b border-[#E7E5E4]"><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Dermatology<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Whitefield<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Available Today<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Home Visit<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Fee: Under ₹500<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span></div>
{/* Availability Filter */}
...
<div className="space-y-2 text-caption font-caption text-[#1C1917]"><label className="flex items-center gap-2.5 cursor-pointer"><input className="w-[18px] h-[18px] rounded text-[#C1121F] focus:ring-[#C1121F] border-[#78716C]" type="checkbox"/><span>In-Clinic Visit</span></label><label className="flex items-center gap-2.5 cursor-pointer"><input className="w-[18px] h-[18px] rounded text-[#C1121F] focus:ring-[#C1121F] border-[#78716C]" type="checkbox"/><span>Video Consultation</span></label><label className="flex items-center gap-2.5 cursor-pointer"><input defaultChecked className="w-[18px] h-[18px] rounded text-[#C1121F] focus:ring-[#C1121F] border-[#78716C]" type="checkbox"/><span>Home Visit</span></label></div>
</div>
{/* Fee Range Slider */}
<div className="space-y-2.5 pt-2 border-t border-[#E7E5E4]">
<div className="flex justify-between items-center"><label className="font-caption-strong text-caption-strong text-[#1C1917]">Consultation Fee</label><span className="font-caption-strong text-caption-strong text-[#C1121F]">Under ₹500</span></div>
...
<div className="max-h-32 overflow-y-auto space-y-1.5 text-caption font-caption text-[#1C1917] pr-1"><label className="flex items-center justify-between cursor-pointer"><span className="flex items-center gap-2"><input className="w-4 h-4 rounded text-[#C1121F] border-[#78716C]" type="checkbox"/>Indiranagar</span><span className="text-micro text-[#78716C]">42</span></label><label className="flex items-center justify-between cursor-pointer"><span className="flex items-center gap-2"><input className="w-4 h-4 rounded text-[#C1121F] border-[#78716C]" type="checkbox"/>Koramangala</span><span className="text-micro text-[#78716C]">54</span></label><label className="flex items-center justify-between cursor-pointer"><span className="flex items-center gap-2"><input defaultChecked className="w-4 h-4 rounded text-[#C1121F] border-[#78716C]" type="checkbox"/>Whitefield</span><span className="text-micro text-[#78716C]">38</span></label><label className="flex items-center justify-between cursor-pointer"><span className="flex items-center gap-2"><input className="w-4 h-4 rounded text-[#C1121F] border-[#78716C]" type="checkbox"/>HSR Layout</span><span className="text-micro text-[#78716C]">49</span></label><label className="flex items-center justify-between cursor-pointer"><span className="flex items-center gap-2"><input className="w-4 h-4 rounded text-[#C1121F] border-[#78716C]" type="checkbox"/>Jayanagar</span><span className="text-micro text-[#78716C]">35</span></label></div>
</div>
{/* Spoken Languages */}
<div className="space-y-2 pt-2 border-t border-[#E7E5E4]">
...
<section className="space-y-4"><div className="bg-[#FAFAF9] border border-[#E7E5E4] rounded-xl p-3 flex flex-wrap items-center justify-between gap-2"><div className="flex flex-wrap items-center gap-1.5"><span className="font-caption-strong text-caption text-[#1C1917] mr-1">Applied:</span><span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#FFFFFF] border border-[#E7E5E4] font-micro text-micro text-[#1C1917]">Dermatology<span className="material-symbols-outlined text-[13px] text-[#78716C] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#FFFFFF] border border-[#E7E5E4] font-micro text-micro text-[#1C1917]">Whitefield<span className="material-symbols-outlined text-[13px] text-[#78716C] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#FFFFFF] border border-[#E7E5E4] font-micro text-micro text-[#1C1917]">Available Today<span className="material-symbols-outlined text-[13px] text-[#78716C] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#FFFFFF] border border-[#E7E5E4] font-micro text-micro text-[#1C1917]">Home Visit<span className="material-symbols-outlined text-[13px] text-[#78716C] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#FFFFFF] border border-[#E7E5E4] font-micro text-micro text-[#1C1917]">Fee: Under ₹500<span className="material-symbols-outlined text-[13px] text-[#78716C] cursor-pointer hover:text-black">close</span></span></div><Link href="/bangalore/doctors" className="font-caption-strong text-caption text-[#C1121F] hover:text-[#8E0E17] transition-colors underline">Reset filters</Link></div><div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-xl p-8 text-center shadow-sm flex flex-col items-center justify-center"><div className="w-16 h-16 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] flex items-center justify-center mb-4"><span className="material-symbols-outlined text-[32px] text-[#C1121F]">search_off</span></div><h2 className="font-headline-h2 text-headline-h2 text-[#1C1917] tracking-tight">No dermatologists found matching all filters</h2><p className="font-body-default text-body-default text-[#5c403d] max-w-[500px] mt-2 leading-relaxed">We couldn’t find any verified dermatologists in Whitefield offering Home Visits today under ₹500. Try clearing specific filters or explore top video consult doctors available immediately.</p><div className="flex flex-col sm:flex-row items-center gap-3 mt-6 w-full max-w-[440px]"><Link href="/bangalore/doctors" className="w-full h-11 bg-[#C1121F] hover:bg-[#8E0E17] text-white font-caption-strong text-caption-strong rounded-lg flex items-center justify-center gap-2 transition active:scale-95 shadow-sm"><span className="material-symbols-outlined text-[18px]">filter_alt_off</span>Clear All Filters</Link><Link href="/consult/lobby/cx-88421" className="w-full h-11 bg-[#FFFFFF] hover:bg-[#FAFAF9] border border-[#C1121F] text-[#C1121F] font-caption-strong text-caption-strong rounded-lg flex items-center justify-center gap-2 transition active:scale-95"><span className="material-symbols-outlined text-[18px]">videocam</span>Switch to Video Consultation (18 Available)</Link></div></div><div className="pt-4 space-y-4"><div className="flex items-center justify-between"><h3 className="font-headline-h3 text-headline-h3 text-[#1C1917]">Top Available Dermatologists in Nearby Localities (Available Today)</h3><span className="text-micro font-micro text-[#047857] bg-[#ECFDF5] px-2.5 py-1 rounded border border-[#A7F3D0] flex items-center gap-1"><span className="material-symbols-outlined text-[14px]" style={{"fontVariationSettings":"'FILL' 1"}}>bolt</span>Available within 2 hours</span></div><div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-xl p-5 hover:border-neutral-300 transition duration-150 relative"><div className="flex gap-4"><div className="relative flex-shrink-0"><img alt="Doctor portrait" className="w-[88px] h-[88px] rounded-full object-cover border border-[#E7E5E4]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCANgKgGJ5AwPuVgz9FgpkKzgcz4i-ZhYGzfwrTP-MtUsBn7JtI5eRoAseRuAzJoaNZ-u5LfH_WkPr9CbeYnUC7OSbmPIpnLC3tIqwuPesy3nlomd2U-v0hMMqLFGbVxywPzcvVAZq8ymIdiZyKq5H3GkQknTk_rNQ5IL31bC7wQhzJwp3htgW3FWdZFMa3Ljl9F53HbnlEPi2nh1Ud-ielTdRzX6Kzfuatp9QloJ0rM41x_XSvIjkk"/><span className="absolute bottom-0 right-0 bg-[#ECFDF5] border border-[#A7F3D0] text-[#047857] rounded-full p-0.5 flex items-center justify-center shadow-sm"><span className="material-symbols-outlined text-[16px]" style={{"fontVariationSettings":"'FILL' 1"}}>verified</span></span></div><div className="flex-1 min-w-0 pr-2"><div className="flex items-center gap-1.5"><h4 className="font-headline-h2 text-headline-h2 text-[#1C1917] truncate">Dr. Rajeshwari Iyer</h4><span className="material-symbols-outlined text-[#047857] text-[18px]" style={{"fontVariationSettings":"'FILL' 1"}}>verified_user</span></div><p className="font-caption text-caption text-[#78716C] mt-0.5">MBBS, MD - Dermatology, DNB (Dermatology)</p><p className="font-caption-strong text-caption-strong text-[#1C1917] mt-1">Dermatologist, Trichologist · 16 Years Experience</p><div className="flex items-center gap-1 text-caption font-caption text-[#78716C] mt-1.5"><span className="material-symbols-outlined text-[16px]">location_on</span><span className="truncate">DermaCare Clinic · Indiranagar (Instant Video Available)</span></div><div className="flex items-center gap-1.5 mt-2.5"><span className="px-2 py-0.5 bg-[#FAFAF9] border border-[#E7E5E4] rounded text-micro font-micro text-[#78716C]">English</span><span className="px-2 py-0.5 bg-[#FAFAF9] border border-[#E7E5E4] rounded text-micro font-micro text-[#78716C]">Kannada</span><span className="px-2 py-0.5 bg-[#FAFAF9] border border-[#E7E5E4] rounded text-micro font-micro text-[#78716C]">Hindi</span></div><div className="flex items-center gap-1.5 mt-3 text-[#047857] font-caption-strong text-caption-strong"><span className="material-symbols-outlined text-[16px]" style={{"fontVariationSettings":"'FILL' 1"}}>thumb_up</span><span>98%</span><span className="text-[#78716C] font-caption text-caption">(840 Patient Stories)</span></div></div><div className="w-40 flex flex-col justify-between items-end border-l border-[#E7E5E4] pl-4"><div className="text-right"><span className="font-caption text-caption text-[#78716C] block">Video consult</span><div className="font-headline-h2 text-headline-h2 text-[#1C1917] font-bold">₹399</div></div><div className="w-full space-y-2 mt-3"><div className="bg-[#ECFDF5] border border-[#A7F3D0] rounded px-2 py-1 flex items-center justify-center gap-1 text-micro font-micro text-[#047857]"><span className="material-symbols-outlined text-[14px]">videocam</span><span>Online Now</span></div><Link href="/consult/room/cx-88421" className="w-full h-10 bg-[#C1121F] hover:bg-[#8E0E17] text-white font-caption-strong text-caption-strong rounded-lg flex items-center justify-center transition active:scale-95 shadow-sm">Start Video Call</Link><Link href="/book" className="w-full h-9 bg-[#FFFFFF] hover:bg-[#FAFAF9] border border-[#C1121F] text-[#C1121F] font-caption-strong text-caption-strong rounded-lg flex items-center justify-center transition active:scale-95">Book Clinic ₹700</Link></div></div></div></div><div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-xl p-5 hover:border-neutral-300 transition duration-150 relative"><div className="flex gap-4"><div className="relative flex-shrink-0"><img alt="Doctor portrait" className="w-[88px] h-[88px] rounded-full object-cover border border-[#E7E5E4]" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBKcIP1kgDyQF50k1L1U9qC6PJQcF3ZroRmTUVogFnplaoxaODqJGBPHD_mjpCuUWRi9k3CExtx7l6JacW7Pqtw5rpeZmpk1IpbxPUSA9FOpTEzzYqsBGbzdMHhJmYJjl635dpyfA1slXPkbCZm4xknTC6KMDD5P2DRpUXwcuUxfwNK8wTqLjdE_jCTXhW9Q2bAdAORRHQaysP_BUPRz4hssEjAsuvAeYwr4swo0Y3vxtgU8wgU4Gdt"/><span className="absolute bottom-0 right-0 bg-[#ECFDF5] border border-[#A7F3D0] text-[#047857] rounded-full p-0.5 flex items-center justify-center shadow-sm"><span className="material-symbols-outlined text-[16px]" style={{"fontVariationSettings":"'FILL' 1"}}>verified</span></span></div><div className="flex-1 min-w-0 pr-2"><div className="flex items-center gap-1.5"><h4 className="font-headline-h2 text-headline-h2 text-[#1C1917] truncate">Dr. Priya Venkatesh</h4><span className="material-symbols-outlined text-[#047857] text-[18px]" style={{"fontVariationSettings":"'FILL' 1"}}>verified_user</span></div><p className="font-caption text-caption text-[#78716C] mt-0.5">MBBS, DNB - Dermatology, Pediatric Dermatology Fellow</p><p className="font-caption-strong text-caption-strong text-[#1C1917] mt-1">Pediatric &amp; Clinical Dermatologist · 9 Years Experience</p><div className="flex items-center gap-1 text-caption font-caption text-[#78716C] mt-1.5"><span className="material-symbols-outlined text-[16px]">location_on</span><span className="truncate">SkinCare Clinic · Near Whitefield / Marathahalli</span></div><div className="flex items-center gap-1.5 mt-2.5"><span className="px-2 py-0.5 bg-[#FAFAF9] border border-[#E7E5E4] rounded text-micro font-micro text-[#78716C]">English</span><span className="px-2 py-0.5 bg-[#FAFAF9] border border-[#E7E5E4] rounded text-micro font-micro text-[#78716C]">Kannada</span><span className="px-2 py-0.5 bg-[#FAFAF9] border border-[#E7E5E4] rounded text-micro font-micro text-[#78716C]">Telugu</span></div><div className="flex items-center gap-1.5 mt-3 text-[#047857] font-caption-strong text-caption-strong"><span className="material-symbols-outlined text-[16px]" style={{"fontVariationSettings":"'FILL' 1"}}>thumb_up</span><span>99%</span><span className="text-[#78716C] font-caption text-caption">(620 Patient Stories)</span></div></div><div className="w-40 flex flex-col justify-between items-end border-l border-[#E7E5E4] pl-4"><div className="text-right"><span className="font-caption text-caption text-[#78716C] block">Video consult</span><div className="font-headline-h2 text-headline-h2 text-[#1C1917] font-bold">₹349</div></div><div className="w-full space-y-2 mt-3"><div className="bg-[#FFF1F2] border border-[#F9C6C9] rounded px-2 py-1 flex items-center justify-center gap-1 text-micro font-micro text-[#8E0E17]"><span className="material-symbols-outlined text-[14px]">schedule</span><span>Today, 6:00 PM</span></div><Link href="/consult/lobby/cx-88421" className="w-full h-10 bg-[#C1121F] hover:bg-[#8E0E17] text-white font-caption-strong text-caption-strong rounded-lg flex items-center justify-center transition active:scale-95 shadow-sm">Book Video ₹349</Link><Link href="/book" className="w-full h-9 bg-[#FFFFFF] hover:bg-[#FAFAF9] border border-[#C1121F] text-[#C1121F] font-caption-strong text-caption-strong rounded-lg flex items-center justify-center transition active:scale-95">In-Clinic ₹650</Link></div></div></div></div></div></section>
