...
type Props = DoctorList & { plural: string; specialty: string };

export default function DoctorListing({ plural, specialty, doctors, total, pages }: Props) {
...
<Link href="/bangalore/specialties" className="whitespace-nowrap text-primary border-b-2 border-primary font-body-strong text-body-strong pb-1">Specialties</Link>
<Link href="/bangalore/doctors" className="whitespace-nowrap text-on-surface-variant font-body-default text-body-default pb-1 hover:text-primary transition-colors duration-150">Doctors</Link>
<Link className="whitespace-nowrap text-on-surface-variant font-body-default text-body-default pb-1 hover:text-primary transition-colors duration-150" href="/records">ABHA ID</Link>
<Link href="/medicines" className="whitespace-nowrap text-on-surface-variant font-body-default text-body-default pb-1 hover:text-primary transition-colors duration-150">Medicines</Link>
<Link href="/lab-tests" className="whitespace-nowrap text-on-surface-variant font-body-default text-body-default pb-1 hover:text-primary transition-colors duration-150">Diagnostic Tests</Link>
<Link href="/bangalore/hospitals" className="whitespace-nowrap text-on-surface-variant font-body-default text-body-default pb-1 hover:text-primary transition-colors duration-150">Hospital Network</Link>
</div>
...
<p className="font-caption text-caption text-[#78716C]">{total.toLocaleString('en-IN')} verified {plural.toLowerCase()} available · Updated today</p>
</div>
</div>
{/* Sort Control */}
...
{/* ==================== 1. LEFT SIDEBAR (FILTERS) — desktop rail ==================== */}
<aside className="hidden lg:block bg-[#FFFFFF] border border-[#E7E5E4] rounded-xl p-4 lg:sticky lg:top-24 space-y-5">
{/* Sidebar Header */}
<div className="flex items-center justify-between pb-3 border-b border-[#E7E5E4]">
<div className="font-headline-h3 text-headline-h3 text-[#1C1917] flex items-center gap-1.5">
...
<ListingFilterGroups filters={filters} activeChips={activeChips} setParam={setParam} setAvailability={setAvailability} />
</aside>
{/* ==================== 2. MAIN RESULTS COLUMN (6 CARDS) ==================== */}
<section className="space-y-4" aria-labelledby="results-heading">
<h2 id="results-heading" className="font-headline-h3 text-headline-h3 text-[#1C1917]">Top-rated {plural.toLowerCase()} available in Bangalore</h2>
{doctors.length === 0 ? (
...
<p className="font-headline-h2 text-headline-h2 text-[#1C1917] tracking-tight">No {plural.toLowerCase()} match these filters</p>
<p className="font-body-default text-body-default text-[#5c403d] max-w-[500px] mt-2 leading-relaxed">Try clearing a filter or two, or browse every verified doctor in Bangalore.</p>
...
<Link href="/bangalore/doctors" className="w-full h-11 bg-[#FFFFFF] hover:bg-[#FAFAF9] border border-[#C1121F] text-[#C1121F] font-caption-strong text-caption-strong rounded-lg flex items-center justify-center gap-2 transition active:scale-95">
<span className="material-symbols-outlined text-[18px]">groups</span>Browse all doctors
</Link>
</div>
</div>
) : (
doctors.map((doctor) => (
<DoctorCard key={doctor.id} doctor={doctor} nextSlot={doctor.nextSlotAt ? { id: '', startsAt: doctor.nextSlotAt, mode: 'clinic', fee: doctor.fee } : null} onOpen={openDoctor(`/doctor/${doctor.slug}`)} />
))
)}
{/* Centered Pagination */}
{pages > 1 && (
...
<h2 className="font-headline-h2 text-headline-h2 text-[#1C1917] mb-4">Frequently Asked Questions</h2>
{/* FAQ Item 1 */}
<div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-lg p-4">
<div className="w-full flex items-center justify-between gap-2">
<h3 className="text-left font-body-strong text-body-strong text-[#1C1917]">1. What is the consultation fee of a top dermatologist in Bangalore?</h3>
<span className="material-symbols-outlined text-[20px] text-[#78716C]" aria-hidden="true">expand_more</span>
</div>
<h4 className="mt-2 text-caption font-caption text-[#5c403d] leading-relaxed">
...
<div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-lg p-4">
<div className="w-full flex items-center justify-between gap-2">
<h3 className="text-left font-body-strong text-body-strong text-[#1C1917]">2. Can I consult a dermatologist online via Curxx?</h3>
<span className="material-symbols-outlined text-[20px] text-[#78716C]" aria-hidden="true">expand_more</span>
</div>
<h4 className="mt-2 text-caption font-caption text-[#5c403d] leading-relaxed">
...
<div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-lg p-4">
<div className="w-full flex items-center justify-between gap-2">
<h3 className="text-left font-body-strong text-body-strong text-[#1C1917]">3. How soon can I get an in-person clinic appointment?</h3>
<span className="material-symbols-outlined text-[20px] text-[#78716C]" aria-hidden="true">expand_more</span>
</div>
<h4 className="mt-2 text-caption font-caption text-[#5c403d] leading-relaxed">
...
<h3 className="font-body-strong text-body-strong">4. Are dermatologist consultations covered under ABHA or health insurance?</h3>
...
<div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-lg p-4">
<div className="w-full flex items-center justify-between gap-2">
<h3 className="text-left font-body-strong text-body-strong text-[#1C1917]">5. How does Curxx verify doctor credentials?</h3>
<span className="material-symbols-outlined text-[20px] text-[#78716C]" aria-hidden="true">expand_more</span>
</div>
<h4 className="mt-2 text-caption font-caption text-[#5c403d] leading-relaxed">
...
<div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-lg p-4">
<div className="w-full flex items-center justify-between gap-2">
<h3 className="text-left font-body-strong text-body-strong text-[#1C1917]">6. Does a consultation include a free follow-up?</h3>
<span className="material-symbols-outlined text-[20px] text-[#78716C]" aria-hidden="true">expand_more</span>
</div>
<h4 className="mt-2 text-caption font-caption text-[#5c403d] leading-relaxed">
