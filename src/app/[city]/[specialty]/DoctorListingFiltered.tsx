...
export default function DoctorsFiltersPagePage({ plural }: { plural: string }) {
...
<p className="font-caption text-caption text-[#78716C]">42 verified dermatologists · Filtered results · Updated today</p>
</div>
</div>
{/* Sort Control */}
...
<button type="button" onClick={clearFilters} className="font-caption-strong text-caption-strong text-[#C1121F] hover:text-[#8E0E17] transition-colors">Clear all (5)</button>
</div>
{/* Applied Chips */}
<div className="flex flex-wrap gap-1.5 pb-3 border-b border-[#E7E5E4]"><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Dermatology<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Indiranagar<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Available Today<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Video Consultation<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span><span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-micro text-micro text-[#8E0E17]">Fee: Under ₹800<span className="material-symbols-outlined text-[14px] cursor-pointer hover:text-black">close</span></span></div>
{/* Availability Filter */}
...
<div className="space-y-2 text-caption font-caption text-[#1C1917]"><label className="flex items-center gap-2.5 cursor-pointer"><input className="w-[18px] h-[18px] rounded text-[#C1121F] focus:ring-[#C1121F] border-[#78716C]" type="checkbox"/><span>In-Clinic Visit</span></label><label className="flex items-center gap-2.5 cursor-pointer"><input defaultChecked className="w-[18px] h-[18px] rounded text-[#C1121F] focus:ring-[#C1121F] border-[#78716C]" type="checkbox"/><span className="font-caption-strong text-[#1C1917]">Video Consultation</span></label><label className="flex items-center gap-2.5 cursor-pointer"><input className="w-[18px] h-[18px] rounded text-[#C1121F] focus:ring-[#C1121F] border-[#78716C]" type="checkbox"/><span>Home Visit</span></label></div>
</div>
{/* Fee Range Slider */}
<div className="space-y-2.5 pt-2 border-t border-[#E7E5E4]">
<div className="flex justify-between items-center">
<label className="font-caption-strong text-caption-strong text-[#1C1917]">Consultation Fee</label>
<span className="font-caption-strong text-caption-strong text-[#C1121F]">Under ₹800</span>
</div>
...
<section className="space-y-4"><div className="bg-[#FFFFFF] border border-[#E7E5E4] rounded-xl p-3.5 shadow-sm space-y-2.5"><div className="flex items-center justify-between"><div className="flex items-center gap-2"><span className="text-caption-strong font-caption-strong text-[#1C1917]">Applied Filters (5)</span><span className="text-micro font-micro text-[#047857] bg-[#ECFDF5] border border-[#A7F3D0] px-2 py-0.5 rounded-full font-medium">Showing 42 matches</span></div><button type="button" onClick={clearFilters} className="text-caption-strong font-caption-strong text-[#C1121F] hover:text-[#8E0E17] transition-colors flex items-center gap-1"><span className="material-symbols-outlined text-[16px]">restart_alt</span>Clear all filters (5)</button></div><div className="flex flex-wrap items-center gap-2"><span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-caption text-caption text-[#8E0E17] font-medium">Dermatology<button aria-label="Remove Dermatology filter" className="material-symbols-outlined text-[16px] hover:text-black transition-colors leading-none">close</button></span><span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-caption text-caption text-[#8E0E17] font-medium">Indiranagar<button aria-label="Remove Indiranagar filter" className="material-symbols-outlined text-[16px] hover:text-black transition-colors leading-none">close</button></span><span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-caption text-caption text-[#8E0E17] font-medium">Available Today<button aria-label="Remove Available Today filter" className="material-symbols-outlined text-[16px] hover:text-black transition-colors leading-none">close</button></span><span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-caption text-caption text-[#8E0E17] font-medium">Video Consultation<button aria-label="Remove Video Consultation filter" className="material-symbols-outlined text-[16px] hover:text-black transition-colors leading-none">close</button></span><span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FFF1F2] border border-[#F9C6C9] font-caption text-caption text-[#8E0E17] font-medium">Fee: Under ₹800<button aria-label="Remove Fee filter" className="material-symbols-outlined text-[16px] hover:text-black transition-colors leading-none">close</button></span></div></div>
{/* DOCTOR CARD 1 */}
...
<Link href="/book" className="w-full h-10 bg-[#C1121F] hover:bg-[#8E0E17] text-white font-caption-strong text-caption-strong rounded-lg flex items-center justify-center transition active:scale-95 shadow-sm">
                  Book Clinic Visit
                </Link>
<Link href="/consult/lobby/cx-88421" className="w-full h-9 bg-[#FFFFFF] hover:bg-[#FAFAF9] border border-[#C1121F] text-[#C1121F] font-caption-strong text-caption-strong rounded-lg flex items-center justify-center transition active:scale-95">
                  Video ₹399
                </Link>
</div>
</div>
...
<button type="button" onClick={clearFilters} className="mt-4 w-full h-10 border border-[#C1121F] text-[#C1121F] hover:bg-[#FFF1F2] font-caption-strong text-caption-strong rounded-lg flex items-center justify-center gap-1.5 transition">Clear all (5)</button>
</div>
